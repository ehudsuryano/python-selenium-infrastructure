...
def test_reach_widgets_page(driver):
    ...
    widgets_page.scroll_to_element_by_name(driver, "Select Menu")
    widgets_page.click_side_menu_item(driver, "Select Menu")
    widgets_page.click_dropdown_menu(driver, " css-2b097c-container")
    widgets_page.click_dropdown_menu(driver, " css-2b097c-container")
    time.sleep(1)
    widgets_page.click_dropdown_menu(driver, "selectOne")
    widgets_page.click_dropdown_menu(driver, "selectOne")
    time.sleep(1)
    widgets_page.click_dropdown_menu(driver, "oldSelectMenu")
    widgets_page.click_dropdown_menu(driver, "oldSelectMenu")
    time.sleep(1)
    widgets_page.click_dropdown_menu(driver, "withOptGroup")
    widgets_page.click_dropdown_menu(driver, "withOptGroup")
    time.sleep(3)
    try:
